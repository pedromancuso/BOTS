...
void restartconfig() { /*REINICIAR ARDUINO CON CONFIGURACIONES DE EEPROM*/
  if (EEPROMr.read(WIFIDIR + DATA_OFFSET) != 255 && EEPROMr.read(WIFIDIR + DATA_OFFSET) != 0) {
    ...
    }else{Serial.println(F("Configuracion WIFI EEPROM Fallada. Reiniciando Red AP..."));wificonfig();}
  }else{Serial.println(F("EEPROM sin registro de Inicio. Continuar por AP..."));}
}
////////////////////////////////WIFISETUP//////////////////////////////////////////////////////////////////////////
